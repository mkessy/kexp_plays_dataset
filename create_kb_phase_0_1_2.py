...
def create_enum_types(conn: duckdb.DuckDBPyConnection):
    ...
    enum_statements = [
        ...
        "CREATE TYPE IF NOT EXISTS link_type AS ENUM ('OFFICIAL_WEBSITE', 'BANDCAMP', 'ARTICLE', 'PERFORMANCE_VIDEO', 'SOCIAL_MEDIA', 'EVENT_PAGE', 'OTHER');",
        "CREATE TYPE IF NOT EXISTS work_of_art_type AS ENUM ('SONG', 'ALBUM');",
        "CREATE TYPE IF NOT EXISTS entity_type AS ENUM ('ARTIST', 'SONG', 'RELEASE', 'LABEL', 'EVENT', 'GENRE', 'LOCATION', 'PERSON', 'ROLE');",
