Okay, let's define the knowledge graph schema focusing on core components first, and then I'll provide the detailed categories document with examples from the data.
